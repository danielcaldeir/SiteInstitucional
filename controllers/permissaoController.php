    ...
    public function editItemAction($id, $mensagem = "") {
        ...
        if (!empty($id)){
            ...
            if ($perItens->numRows() > 0){
                ...
                else{ $mensagem = "Nao foi informado nenhum nome!"; }
            } 
            else { $mensagem = "Nao foi encontrado o Item Selecionado."; }
            
            $this->editItem($id, $mensagem);
        } 
        else { $this->index($mensagem); }
    }
        ...
        if (!empty($id)){
            ...
            if ($perGrupo->numRows() > 0){
                ...
                if (!empty($_POST['nome'])){
                    ...
                    else{ $mensagem = "Nao ha Items!"; }
                } 
                else{ $mensagem = "Nao foi vinculado uma permissao!"; }
            } 
            else { $mensagem = "Nao foi encontrado um grupo vinculado."; }
