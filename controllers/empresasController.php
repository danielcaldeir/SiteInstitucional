        ...
        if (count($principal) > 0) {
            if (!empty($principal['cnpj']) && !empty($principal['fantasia'])) {
                ...
                if ($empresa->numRows() > 0) {
                    ...
                    $mensagem = "Nao foi encontrado um Identificador Valido!";
                }
            } else {
                $mensagem = "Nao foi possivel realizar a Alteracao!";
            }
        } else {
            $mensagem = "Nao ha valores para serem modificados";
        }
        return $mensagem;
    }
